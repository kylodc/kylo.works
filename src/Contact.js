...
export default function Contact() {
    ...
    const handleSubmit = async (e) => {
        ...
        const mailtoLink = `mailto:johnkylodc12@gmail.com?subject=${encodeURIComponent(formData.subject || 'Portfolio Contact Form Message')}&body=${encodeURIComponent(
                                ...
                                <form className="contact-form" onSubmit={handleSubmit}>
                                    ...
                                    <button type="submit" className="submit-btn" disabled={isSubmitting}>
                                        {isSubmitting ? (
                                            <>
                                                Sending...
                                                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" style={{ marginLeft: '8px', animation: 'spin 1s linear infinite' }}>
